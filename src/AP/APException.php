...
class APException extends PoolPortException
{
    public static $errors = array(
        ...
        '92' => 'مسیری برای ارسال تراکنش به مقصد یافت نشد. ) موسسه های اعالمی معتبر نیستند(',
        '93' => ' تراکنش با موفقیت انجام نشد. )کمبود منابع و نقض موارد قانونی(',
        '94' => 'رسال تراکنش تکراری.',
        ...
        '805' => 'قبال درخواست تسویه برای این تراکنش ارسال شده است',
        '806' => 'قبال درخواست بازگشت برای این تراکنش ارسال شده است',
        ...
        '813' => 'بازبینی قبال لغو شده است',
        '814' => 'امکان درخواست بعد از گذشت بازه زمانی مجاز پس از Verification وجود ندارد',
        '400' => 'موفق',
        '401' => 'حالت اولیه )مقدار اولیه در شرایط Deserialize/Serialize )',
